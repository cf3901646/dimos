...
all_modules = {
    ...
    "vlnce-connection": "dimos.benchmark.vlnce_r2r.connection.VlnceConnection",
    "vlnce-observation-recorder": "dimos.benchmark.vlnce_r2r.blueprint.VlnceObservationRecorder",
